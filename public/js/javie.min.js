/* Javie version 1.0.0 */
(function(){var a,c,b;a=this;b=a._;if(!b&&("undefined"!==typeof require)){b=require("underscore");}if(!b){throw new Error("Expected Underscore.js not available");
}c=function c(d,e){if(b.isFunction(d)){e=d;d=null;}if((c.ENV===d||b.isNull(d))&&b.isFunction(e)){e.call(c);}};c.ENV="production";a.Javie=c;}).call(this);
